...
MESSAGES: dict[str, str] = {
    ...
    "native.hint_eval": "    /harness-eval       — Adaptive multi-role parallel code review",
    ...
    "init.guide_eval": "Adaptive multi-role parallel code review",
    ...
    "workflow.phase.landing": "Landing (CI monitoring / hotfix)",
    ...
    "progress_line.next.landing": "PR submitted — monitoring CI and auto-fixing failures until merge-ready",

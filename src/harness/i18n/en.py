...
MESSAGES: dict[str, str] = {
    ...
    "init.opt_native": "  1. cursor-native -- Skills + subagents inside Cursor IDE (recommended)",
    "init.opt_orchestrator": "  2. orchestrator -- External CLI process drives cursor-agent",
    ...
    "init.native_adversarial_model": "  Cross-model review model (used by trust-boundary rule)",

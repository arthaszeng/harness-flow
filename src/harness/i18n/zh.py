...
MESSAGES: dict[str, str] = {
    ...
    "init.native_adversarial_model": "  对抗评审模型（跨模型评审）",
    ...
    "native.hint_plan": "    /harness-plan   — 规划和分解任务",
    "native.hint_build": "    /harness-build  — 按计划实现代码",
    "native.hint_eval": "    /harness-eval   — 跨模型对抗评审",
    "native.hint_ship": "    /harness-ship   — 端到端: plan → build → eval → commit → push",

   ...
   进化路线：从“猿人写码”到“L5 自动交付”
     ...
     /  / \   \           /  / \               /  / \  \             /___/ \___\
       _/ \_               _/ \_                 _/ \_                  /   \
        ...
        L0                   L1                    L3                      L5
      手工编程              AI 助手               Agent 模式             Harness Flow
      vim + gcc            Copilot        Cursor Agent/Claude Code       自动交付

    每一行都手写        你开车+AI 辅助       AI 能写但会跑偏           AI 交付产品
      纯手工推进         （手不离方向盘）      （没导航/没交规/没记录）     人类回到副驾
